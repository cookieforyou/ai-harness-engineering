...
- **Skill**: [../../skills/implement-feature/SKILL.md](../../skills/implement-feature/SKILL.md)
...
| 检查点 | 触发条件 | 等待决策 | 下一步 |
|--------|----------|----------|--------|
| **DC-1: 实现方案确认** | 完成技术方案设计后 | 方案是否可行？是否需要调整？ | 继续编码 |
| **DC-2: 代码审查反馈** | 收到审查反馈后 | 如何处理审查意见？ | 修复或讨论 |
| **DC-3: 遗留问题确认** | 发现无法当场解决的问题后 | 遗留问题如何处理？ | 记录并继续 |
...
- **Next**: [../verify-test/SCENARIO.md](../verify-test/SCENARIO.md) - 测试验证
- **Previous**: [../decompose-task/SCENARIO.md](../decompose-task/SCENARIO.md) - 任务分解
