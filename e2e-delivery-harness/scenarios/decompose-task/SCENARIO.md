...
- **Skill**: [../../skills/decompose-task/SKILL.md](../../skills/decompose-task/SKILL.md)
...
| 检查点 | 触发条件 | 等待决策 | 下一步 |
|--------|----------|----------|--------|
| **DC-1: 任务粒度确认** | 完成初步分解后 | 粒度过大/小的任务如何处理？ | 调整后继续 |
| **DC-2: 优先级确认** | 完成优先级排序后 | 优先级排序是否合理？ | 继续迭代规划 |
| **DC-3: Sprint 划分确认** | 完成迭代规划后 | Sprint 划分和里程碑是否合适？ | 进入下一阶段 |
...
- **Next**: [../implement-feature/SCENARIO.md](../implement-feature/SCENARIO.md) - 开发实现
- **Previous**: [../design-system/SCENARIO.md](../design-system/SCENARIO.md) - 系统设计
